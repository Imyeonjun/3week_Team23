...
namespace TextRPG_Team23
{
    ...
    public static class ItemDB
    {
        public static List<Item> Items = new List<Item>()
        {
            ...
            new Consumable("체력 포션", 50, "체력을 30 회복합니다.", p => p.Hp = Math.Min(p.MaxHp, p.CurrentHp + 30)),
            new Consumable("마나 포션", 50, "마나를 30 회복합니다.", p => p.Mp = Math.Min(p.MaxMp, p.CurrentMp + 30))
        };
    }
}